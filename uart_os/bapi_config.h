...
#if defined (FS_IMXRT_TSTAT)
#include "initialize_FS_IMXRT_TSTAT.h"
#elif defined (FS_IPVAV)
    #include "initialize_FS_IPVAV.h"
#elif defined (FS_SNAP_ON_IO)
    #include "initialize_FS_SNAP_ON_IO.h"
#elif FS_IMXRTEVAL
	#include "initialize_FS_IMXRTEVAL.h"
#elif defined (FS_BEATS_IO)
    #include "initialize_FS_BEATS_IO.h"
#endif
...
C_FUNC uint32_t BOARD_DebugConsoleSrcFreq(void);
/*******************************************************************************
 * Definitions
 ******************************************************************************/
/*! @brief The board name */
...
#define BOARD_USDHC_CD_GPIO_PIN                 (28)
#define BOARD_USDHC_CD_PORT_IRQ                 GPIO2_Combined_16_31_IRQn
#define BOARD_USDHC_CD_PORT_IRQ_HANDLER         __GPIO2_Combined_16_31_IRQHandler
#define BOARD_USDHC_CD_STATUS()                 (GPIO_PinRead(BOARD_USDHC_CD_GPIO_BASE, BOARD_USDHC_CD_GPIO_PIN))
#define BOARD_USDHC_CD_INTERRUPT_STATUS()       (GPIO_PortGetInterruptFlags(BOARD_USDHC_CD_GPIO_BASE))
#define BOARD_USDHC_CD_CLEAR_INTERRUPT(flag)    (GPIO_PortClearInterruptFlags(BOARD_USDHC_CD_GPIO_BASE, flag))
...
/* BEGIN: Added by Howard Xue, 2019/11/16 */
...
/* END:   Added by Howard Xue, 2019/11/16   PN: */
...
#define BOARD_485_UART_BASEADDR                 LPUART5
#define BOARD_485_UART_CLK_FREQ                 BOARD_DebugConsoleSrcFreq()
#define BOARD_485_UART_IRQ                      LPUART5_IRQn
#define BOARD_485_UART_IRQ_HANDLER              LPUART5_IRQHandler
...
//Jerome need to update
#define BOARD_INITPINS_BT_REG_ON_GPIO           GPIO2   /*!< GPIO device name: GPIO1 */
#define BOARD_INITPINS_BT_REG_ON_PORT           GPIO2   /*!< PORT device name: GPIO1 */
#define BOARD_INITPINS_BT_REG_ON_PIN            14U   /*!< GPIO1 pin index: 24 */


#define BOARD_INITPINS_BT_HCI_TX_PERIPHERAL     LPUART8   /*!< Device name: LPUART3 */
#define BOARD_INITPINS_BT_HCI_TX_SIGNAL         TX   /*!< LPUART3 signal: TX */


#define BOARD_INITPINS_BT_HCI_RX_PERIPHERAL     LPUART8  /*!< Device name: LPUART3 */
#define BOARD_INITPINS_BT_HCI_RX_SIGNAL         RX   /*!< LPUART3 signal: RX */

#define BOARD_INITPINS_BT_HCI_CTS_PERIPHERAL    LPUART8   /*!< Device name: LPUART3 */
#define BOARD_INITPINS_BT_HCI_CTS_SIGNAL        CTS_B   /*!< LPUART3 signal: CTS_B */


#define BOARD_INITPINS_BT_HCI_RTS_PERIPHERAL    LPUART8   /*!< Device name: LPUART3 */
